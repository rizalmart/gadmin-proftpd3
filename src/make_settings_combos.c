...
GtkWidget * make_combo_with_label(GtkTable * table,
                        const gchar * label_text, gint left_attach,
                              ...
                              gint bottom_attach, gint combo_length)
{
    GtkWidget *combo;
    GtkWidget *label;
...
GtkWidget * make_combo(GtkTable * table, gint left_attach, gint right_attach,
            gint top_attach, gint bottom_attach, gint combo_length)
{
    GtkWidget *combo;
    combo = gtk_combo_box_text_new();
