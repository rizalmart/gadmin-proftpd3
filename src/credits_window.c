...
void show_credits()
{
    ...
    gtk_scrolled_window_set_shadow_type(GTK_SCROLLED_WINDOW(credits_scrolledwindow),
    ...
    g_signal_connect_swapped((gpointer) close_credits_button,
            "clicked", G_CALLBACK(gtk_widget_destroy), G_OBJECT(credits_window));
